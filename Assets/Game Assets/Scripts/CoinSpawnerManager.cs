...
public class CoinSpawnerManager : MonoBehaviour
{
    ...
    public void SpawnCoinFromSpawner1()
    {
        ...
        Instantiate(coinPrefab, spawner1.transform.position + randomPos, Quaternion.identity).GetComponent<Coin>().isFromSpawner1 = true;
    }
    ...
    public void SpawnCoinFromSpawner2()
    {
        ...
        Vector3 randomPos = Random.insideUnitCircle * Radius;
        randomPos = new Vector3(randomPos.x, 0, randomPos.y);
        Instantiate(coinPrefab, spawner2.transform.position + randomPos, Quaternion.identity).GetComponent<Coin>().isFromSpawner1 = false;
    }
}
